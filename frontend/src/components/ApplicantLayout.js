...
import {
  FiHome, FiBriefcase, FiFileText, FiCalendar,
...
const ApplicantLayout = () => {
  ...
  const navigation = [
    { name: 'Dashboard', path: '/applicant/dashboard', icon: FiHome },
    { name: 'Browse Jobs', path: '/applicant/jobs', icon: FiBriefcase },
    { name: 'My Profile', path: '/applicant/profile', icon: FiFileText },
    { name: 'My Interviews', path: '/applicant/interviews', icon: FiCalendar },
  ];
      ...
      <div className={`${sidebarOpen ? 'w-64' : 'w-20'} bg-white dark:bg-gray-800 shadow-lg transition-all duration-300`}>
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center justify-between p-4 border-b dark:border-gray-700">
            {sidebarOpen && (
              <h1 className="text-xl font-bold text-primary-600 dark:text-primary-400">Job Portal</h1>
            )}
            <button
